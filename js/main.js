...
function start() {
    ...
    // função para mover a nave cinza
    function moveJogador() {
        if (jogo.pressionou[TECLA.W]) {
            var topo = parseInt($("#jogador").css("top"));
            $("#jogador").css("top",topo - 10);

            // limitando a nave no topo da página para não sair da tela
            if (topo<=0) {
                $("#jogador").css("top",topo + 10);
            }
        }
        ...
        if (jogo.pressionou[TECLA.S]) {
            ...
            // limitando a nave no final da página para não sair da tela na parte inferior
            if (topo>=434) {	
                $("#jogador").css("top",topo - 10);		
            }
        }
    ...
    // função para mover o inimigo 1, nave amarela
    ...
    // função para mover o amigo a ser resgatado
    function moveAmigo() {
    ...
    function colisao() {
        ...
        // colisão do jogador com o inimigo1 - nave
